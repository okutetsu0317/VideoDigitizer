const CACHE_NAME = "video-digitizer-shell-v2.2.0-reliability2";
const APP_SHELL = [
  "./",
  "./index.html",
  "./native-bridge.js?v=2.2.0-ios1",
  "./styles.css?v=2.2.0-reliability2",
  "./frame-source.js?v=2.2.0-reliability2",
  "./pwa.js?v=2.2.0-reliability2",
  "./ai-pose.js?v=2.2.0-reliability2",
  "./ai-pose-worker.js?v=2.2.0-reliability2",
  "./point-tracker.js?v=2.2.0-reliability2",
  "./point-tracker-worker.js?v=2.2.0",
  "./step-analysis-core.js?v=2.2.0-reliability2",
  "./step-analysis.js?v=2.2.0-reliability2",
  "./analysis-aggregate-worker.js?v=2.2.0-reliability2",
  "./app.js?v=2.2.0-reliability2",
