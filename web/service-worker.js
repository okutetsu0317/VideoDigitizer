const CACHE_NAME = "video-digitizer-shell-v2.2.0-lite1";
const APP_SHELL = [
  "./",
  "./index.html",
  "./native-bridge.js?v=2.2.0-ios1",
  "./styles.css?v=2.2.0-lite1",
  "./frame-source.js?v=2.2.0-lite1",
  "./pwa.js?v=2.2.0-lite1",
  "./ai-pose.js?v=2.2.0-lite1",
  "./ai-pose-worker.js?v=2.2.0-lite1",
  "./point-tracker.js?v=2.2.0-lite1",
  "./point-tracker-worker.js?v=2.2.0",
  "./step-analysis-core.js?v=2.2.0-lite1",
  "./step-analysis.js?v=2.2.0-lite1",
  "./app.js?v=2.2.0-lite1",
