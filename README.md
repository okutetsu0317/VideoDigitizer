...
[プライバシーポリシーを読む](https://okutetsu0317.github.io/VideoDigitizer/privacy.html)
...
次期Macアプリ版では任意のGoogleログインにより、同じMac内の自動保存を利用者ごとに分けて再開できます。動画や座標をGoogleへ同期する機能ではありません。公開中のダウンロード版は、この機能を含む更新版の署名・公証が完了するまでは従来版のままです。
...
- [セキュリティ・プライバシー設計](docs/security_privacy_ja.md)
- [知的財産・配布監査記録](docs/legal_review_2026-08-10_ja.md)
